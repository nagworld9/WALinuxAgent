...
class UpdateHandler(object):
    ...
    def __init__(self):
        ...
        self._last_check_memory_usage = None
    ...
    def _check_agent_memory_usage(self):
        ...
        """
        try:
            if self._last_check_memory_usage is None:
                self._last_check_memory_usage = datetime.utcnow() - UpdateHandler.CHECK_MEMORY_USAGE_PERIOD

            if conf.get_enable_agent_memory_usage_check() and self._extensions_summary.converged:
                if datetime.utcnow() >= (self._last_check_memory_usage + UpdateHandler.CHECK_MEMORY_USAGE_PERIOD):
